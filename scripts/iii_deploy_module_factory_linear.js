...
async function main() {
  ...
  const modulefactory = await ERC20LinearRewardModuleFactory.connect(ledger).deploy({ maxFeePerGas: network.config.gas, maxPriorityFeePerGas: network.config.priority });
