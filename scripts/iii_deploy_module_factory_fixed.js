...
async function main() {
  ...
  const modulefactory = await ERC20FixedRewardModuleFactory.connect(ledger).deploy({ maxFeePerGas: network.config.gas, maxPriorityFeePerGas: network.config.priority });
