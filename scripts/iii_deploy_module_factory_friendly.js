...
async function main() {
  ...
  const modulefactory = await ERC20FriendlyRewardModuleFactory.connect(ledger).deploy({ maxFeePerGas: network.config.gas, maxPriorityFeePerGas: network.config.priority });
